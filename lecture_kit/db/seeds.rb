...
PlantCategory.create(plant_id: succulent.id, category_id: outdoor.id)
PlantCategory.create(plant_id: succulent.id, category_id: indoor.id)
PlantCategory.create(plant_id: succulent.id, category_id: succulent.id)
...
Watering.create(plant_id: elephant_bush.id, person_id: joel.id)
Watering.create(plant_id: polka_dot_plant.id, person_id: sylwia.id)
Watering.create(plant_id: polka_dot_plant.id, person_id: joel.id)
